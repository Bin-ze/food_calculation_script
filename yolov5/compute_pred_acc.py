...
class Cumpute_pred_acc:
    ...
    def __init__(self, pred_path, label_path, iou_thres=0.4, result_sava_path='./', classes_dict=None, mask=None, single_cls=False):
        """
...
if __name__ == '__main__':
    ...
    compute = Cumpute_pred_acc(pred_path=args.pred_path, label_path=args.label_path, result_sava_path=args.result_save_path, mask=None, single_cls=True)
    compute()
