...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_file', default=r'/mnt/data/guozebin/object_detection/yolov7/data/coco/annotations/instances_train2017.json',
                        type=str, help="coco file path")
    parser.add_argument('--save_dir', default='/mnt/data/guozebin/object_detection/yolov7/data/coco/labels/test/', type=str,
