...
class Statistics_class:
    ...
    def statistics_sort(self, dict_input, sort=False):
        ...
        for result_key in result_key:
            ...
            for key,val in sorted(sort_dict.items(), key=lambda x:int(x[0])):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', type=str, default="/mnt/data/guozebin/fake_real_data_0-14/0301/coco", help='yolov5 format dataset path or xml or json path')
    ...
    #dit = test.statistics_from_coco_json()
