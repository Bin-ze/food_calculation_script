...
def get_random_data(class_result, max_class_nums, split='train'):
    ...
    #train_img_path = ['/mnt/data/guozebin/object_detection/yolov7/data/coco/images/train',f'/mnt/data/guozebin/fake_real_data_merge/{DAY}/coco/images/train']
    train_img_path = [f'/mnt/data/guozebin/fake_real_data_merge/{DAY}/coco/images/train']

    #train_txt_path = ['/mnt/data/guozebin/object_detection/yolov7/data/coco/labels/train', f'/mnt/data/guozebin/fake_real_data_merge/{DAY}/coco/labels/train']
    train_txt_path = [f'/mnt/data/guozebin/fake_real_data_merge/{DAY}/coco/labels/train']
...
if __name__ == '__main__':
    class_result, cla_ZH_dict = create_index()
