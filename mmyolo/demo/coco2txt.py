...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_file', default=r'/mnt/data/guozebin/object_detection/mmyolo/data/0302/food/annotations/instances_val2017.json',
                        type=str, help="coco file path")
    parser.add_argument('--save_dir', default='/mnt/data/guozebin/object_detection/mmyolo/data/0302/food/val2compute_acc', type=str,
    ...
    with open(os.path.join(arg.save_dir, 'classes.txt'), 'w') as f:
        for i, category in enumerate(data['categories']):
            ...
            id_map[category['id']] = category['id']
